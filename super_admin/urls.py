...
urlpatterns = [
    ...
    path('review/delete/<int:app_id>/', views.delete_application_view, name='delete_application'),
    ...
    path('institutions/delete/<int:inst_id>/', views.delete_institution_view, name='delete_institution'),
